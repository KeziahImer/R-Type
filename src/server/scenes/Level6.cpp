...
Server::Scenes::Level6::Level6(RNGine::Core &core) {
  CreateShipFactory();
  CreateEnemyFactory();
  ...
  AddComponent<Client::Components::EnemyWaveSpawn>(
      CreateEntity("enemyWaveSpawn1"), {1, 1, 1500, {BOSS_TYPE_2_HEAD}});
  AddComponent<Client::Components::EnemyWaveSpawn>(
      CreateEntity("enemyWaveSpawn2"), {2, 10, 201, {BOSS_TYPE_2_BODY}});
