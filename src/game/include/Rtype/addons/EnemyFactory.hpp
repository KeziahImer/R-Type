...
const std::pair<std::map<std::string, ValueFirstMap>,
    ...
    ENEMY_TYPE_3 = {
        {{"width", 1.8f},
         ...
         {"hitboxFirst", std::pair<float, float>(96.33f * 0.5f, 44.0f * 0.5f)},
         {"hitboxSecond", std::pair<float, float>(0.0f, 0.0f)},
         {"damages", 150.0f},
         {"collider", std::pair<bool, RNGine::Addons::CollisionAction>(
                          false, RNGine::Addons::CollisionAction::None)},
        ...
        {{"width", 2.0f},
         ...
         {"shootPattern",
          std::pair<
              ...
              {
                  {RNGine::Core::Time(1),
                   std::make_pair(100.0f, std::make_pair(-700.0f, 100.0f))},
                  {RNGine::Core::Time(2),
                   std::make_pair(100.0f, std::make_pair(-700.0f, -100.0f))},
              },
          })},
...
struct EnemyCreationRequest {
  ...
  static EnemyCreationRequest createShipCreationRequest(
