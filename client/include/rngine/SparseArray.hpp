...
** R-type
** File description:
** SparseArray definition
*/

#ifndef _RNGINE_TYPES_SPARSEARRAY_HPP_
#define _RNGINE_TYPES_SPARSEARRAY_HPP_
...
namespace RNGine {
/**
 * @brief SparseArray is like a vector but with the possibility that at a
 * specifique index the data doesn't exist
 */
