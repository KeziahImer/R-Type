...
ComponentFactory::ComponentFactory(GameEngine::Registry &registry)
    : _registry(registry) {
  this->_components.emplace("sprite", [this](std::string id,
                                             const GameEngine::EntityID &entity,
                                             const json &data) {
  ...
  this->_components.emplace(
      "position", [this](std::string id, const GameEngine::EntityID &entity,
                         const json &data) {
        float x = data["x"];
        float y = data["y"];
  ...
  this->_components.emplace("size", [this](std::string id,
                                           const GameEngine::EntityID &entity,
                                           const json &data) {
  ...
  this->_components.emplace(
      "velocity", [this](std::string id, const GameEngine::EntityID &entity,
                         const json &data) {
        float x = data["x"];
        float y = data["y"];
  ...
  this->_components.emplace(
      "movable", [this](std::string id, const GameEngine::EntityID &entity,
                        const json &data) {
  ...
  this->_components.emplace("shoot", [this](std::string id,
                                            const GameEngine::EntityID &entity,
                                            const json &data) {
  ...
  this->_components.emplace(
      "parallax", [this](std::string id, const GameEngine::EntityID &entity,
                         const json &data) {
